...
<head>
    @include('partials.meta', ['pageTitle' => 'My Grades | Digitech College'])
...
<body data-student-page="grades" class="student-portal min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="lg:pl-64">
        @include('student.components.header', ['title' => 'My Grades', 'subtitle' => 'Academics'])
        <main class="p-4 sm:p-6 lg:p-8">
            <div class="mx-auto max-w-7xl">
                <section class="mb-7 p-6 sm:p-8">
                    <p class="text-xs font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-400">Academic record</p>
                ...
                <div id="semesterTabs" class="mb-6 flex items-center gap-2">
                    <button type="button" data-tab="1st Semester"
                        class="rounded border border-blue-600 bg-blue-600 px-4 py-2 text-sm font-semibold text-white">1st Semester</button>
                    <button type="button" data-tab="2nd Semester"
                        class="rounded border border-slate-200 px-4 py-2 text-sm font-semibold dark:border-slate-700">2nd Semester</button>
                </div>
                <section class="mb-6 grid gap-4 sm:grid-cols-3">
                    <div class="portal-stat card p-5">
                        ...
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">Published subjects</p>
                    ...
                    <div class="portal-stat card p-5">
                        ...
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">General average</p>
                        <p id="gradeAverage" class="mt-1 text-3xl font-extrabold text-emerald-600 dark:text-emerald-400">—</p>
                    </div>
                    <div class="portal-stat card p-5">
                        <span class="portal-stat-icon bg-violet-50 text-violet-600 dark:bg-violet-950/50 dark:text-violet-300">
                            <i data-lucide="award"></i>
                        </span>
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">GWA (CHED)</p>
                        <p id="gradeGwa" class="mt-1 text-3xl font-extrabold text-violet-600 dark:text-violet-400">—</p>
                    </div>
                </section>
                ...
                <section id="annualSection" class="mt-6 hidden card overflow-hidden">
                    <div class="border-b border-slate-200 px-5 py-4 dark:border-slate-800">
                        <div class="flex items-center gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded bg-purple-50 text-purple-600 dark:bg-purple-950/50 dark:text-purple-300">
                    ...
                    <div class="grid gap-4 p-5 sm:grid-cols-4">
                        ...
                        <div class="rounded bg-slate-50 p-4 dark:bg-slate-800">
                            ...
                            <p id="annualAverage" class="mt-1 text-xl font-bold text-emerald-600 dark:text-emerald-400">—</p>
                        </div>
                        <div class="rounded bg-slate-50 p-4 dark:bg-slate-800">
                            <p class="text-[11px] text-slate-400">Annual GWA</p>
                            <p id="annualGwa" class="mt-1 text-xl font-bold text-blue-600 dark:text-blue-400">—</p>
                        </div>
                    </div>
                </section>
            </div>
