...
<head>
    @include('partials.meta', ['pageTitle' => 'Online Enrollment | Digitech College'])
            ...
            <div class="mx-auto max-w-6xl">
                ...
                <form id="enr" class="space-y-6">
                        ...
                        <div class="mt-6 grid gap-5 md:grid-cols-3">
                            <label class="text-sm font-semibold">
                                ...
                                <input id="fullName" readonly
                                    class="input mt-1.5 w-full rounded border bg-slate-50 px-3 py-2.5 dark:bg-slate-800" />
                            </label>
                            <label class="text-sm font-semibold">
                                Student ID
                                <input id="studentId" readonly
                                    class="input mt-1.5 w-full rounded border bg-slate-50 px-3 py-2.5 font-mono text-xs dark:bg-slate-800" />
                            </label>
                            <label class="text-sm font-semibold">
                                Contact number
                                <input id="contact" required class="input mt-1.5 w-full rounded border px-3 py-2.5"
                            ...
                            <label class="text-sm font-semibold md:col-span-2">
                                Home address
                                <input id="address" required class="input mt-1.5 w-full rounded border px-3 py-2.5"
                    ...
                    <section class="card p-5 sm:p-7">
                        <div class="flex items-start gap-3 border-b border-slate-200 pb-5 dark:border-slate-700">
                            <span
                                class="flex h-10 w-10 items-center justify-center rounded bg-amber-50 text-amber-600 dark:bg-amber-950/50 dark:text-amber-300">
                                <i data-lucide="contact"></i>
                            </span>
                            <div>
                                <h3 class="font-extrabold">Guardian information</h3>
                                <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Add a guardian contact for enrollment and
                                    emergency
                                    communication.</p>
                            </div>
                        </div>
                        <div class="mt-6 grid gap-5 md:grid-cols-2">
                            <label class="text-sm font-semibold">
                                ...
                                <input id="guardianName" required
                                    class="input mt-1.5 w-full rounded border px-3 py-2.5" placeholder="Full name" />
                            </label>
                            <label class="text-sm font-semibold">
                                Guardian contact
                    ...
                    <section class="card p-5 sm:p-7">
                        ...
                        <div class="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            <label class="text-sm font-semibold">
                                Program type
                                <select id="programType" class="input mt-1.5 w-full rounded border px-3 py-2.5">
                            ...
                            <label class="text-sm font-semibold">
                                ...
                                <span id="strandHint" class="mt-1 block text-xs text-slate-500 dark:text-slate-400"></span>
                            </label>
                            <label class="text-sm font-semibold">
                                Track / qualification
                                <select id="track"
                                ...
                                <span id="trackHint" class="mt-1 block text-xs text-slate-500 dark:text-slate-400"></span>
                            </label>
                            <label class="text-sm font-semibold">
                                Training level
                                <select id="training"
                                ...
                                <span id="trainingHint" class="mt-1 block text-xs text-slate-500 dark:text-slate-400"></span>
                            </label>
                            <label class="text-sm font-semibold">
                                School year
                                <input id="schoolYear" required
                                    class="input mt-1.5 w-full rounded border px-3 py-2.5" value="2026-2027" />
                            </label>
                        </div>
                    </section>
                    <section class="card flex flex-col gap-4 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <button type="button" id="saveDraftBtn" onclick="saveEnrollment('Draft')"
                                class="inline-flex items-center gap-2 rounded border border-slate-200 px-5 py-3 text-sm font-semibold dark:border-slate-700">
                                <i data-lucide="save" class="h-4 w-4"></i>
                                Save draft
                            </button>
                            <button type="button" id="submitEnrollmentBtn" onclick="saveEnrollment('Submitted')"
                                class="inline-flex items-center gap-2 rounded bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-700">
