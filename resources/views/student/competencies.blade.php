...
<head>
    @include('partials.meta', ['pageTitle' => 'TVET Competencies | Digitech College'])
...
<body data-student-page="competencies" class="student-portal min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    @include('student.components.sidebar')
    <div class="lg:pl-64">
        @include('student.components.header', ['title' => 'Competencies', 'subtitle' => 'Academics'])
            ...
            <div class="mx-auto max-w-7xl">
                <section class="mb-7 p-6 sm:p-8">
                    <div class="relative z-10 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            ...
                            <p class="mt-3 max-w-2xl text-sm leading-6 text-slate-500">See the outcomes recorded by your
                                teacher and
                ...
                <section class="mb-6 grid gap-4 sm:grid-cols-3">
                    <div class="portal-stat card p-5"><span
                        ...
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">Overall progress</p>
                    ...
                    <div class="portal-stat card p-5"><span
                        ...
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">Competent</p>
                        <p id="competentCount" class="mt-1 text-3xl font-extrabold text-emerald-600 dark:text-emerald-400">0</p>
                    </div>
                    <div class="portal-stat card p-5"><span
                        ...
                        <p class="mt-4 text-sm text-slate-500 dark:text-slate-400">Still in progress</p>
                        <p id="remainingCount" class="mt-1 text-3xl font-extrabold text-amber-600 dark:text-amber-400">0</p>
                    </div>
                </section>
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p class="mt-1 text-xs text-slate-400">Competent outcomes divided by all assigned
                                competencies.</p>
                        </div><span id="progressLabel" class="text-sm font-bold text-emerald-600 dark:text-emerald-400">0 of 0</span>
                    </div>
