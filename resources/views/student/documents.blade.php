...
<body data-student-page="documents" class="student-portal min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="lg:pl-64">
        @include('student.components.header', ['title' => 'Document Requests', 'subtitle' => 'Student Services'])
            ...
            <div class="mx-auto max-w-7xl">
                <section class="mb-7">
                    <div
                        ...
                        <div>
                            <p class="text-xs font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-400">Student services</p>
                        ...
                        <button type="button" onclick="document.getElementById('formBox').classList.toggle('hidden')"
                            class="inline-flex items-center justify-center gap-2 rounded bg-emerald-600 px-5 py-3 text-sm font-semibold 
