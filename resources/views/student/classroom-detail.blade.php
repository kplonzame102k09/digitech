    ...
    <div class="lg:pl-64">
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            <div class="mx-auto max-w-5xl">
                ...
                <section class="student-hero mt-3 mb-7 overflow-hidden rounded-3xl p-6 text-white shadow-xl sm:p-8">
                ...
                <div class="mb-6 flex gap-1 overflow-x-auto rounded-2xl border border-slate-200 bg-white p-1.5 dark:border-slate-800 dark:bg-slate-900 sm:max-w-xl">
                    <button type="button" data-detail-tab="activities" aria-selected="true"
                        class="flex flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl px-3 py-2.5 text-sm font-semibold">Activities</button>
                    <button type="button" data-detail-tab="scores" aria-selected="false"
                        class="flex flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl px-3 py-2.5 text-sm text-slate-500">My scores</button>
                    <button type="button" data-detail-tab="classmates" aria-selected="false"
                        class="flex flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-xl px-3 py-2.5 text-sm text-slate-500">Classmates</button>
                </div>
