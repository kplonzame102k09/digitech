...
<head>
    @include('partials.meta', ['pageTitle' => 'Grades | Digitech College'])
...
<body data-parent-page="grades" class="min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="lg:pl-64">
        @include('parent.components.header', ['title' => 'Grades', 'subtitle' => 'Child progress'])
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="mb-6 flex flex-wrap items-center gap-3">
                    ...
                    <select id="semesterFilter" aria-label="Semester"
                        class="input rounded border px-4 py-2 text-sm font-semibold">
                ...
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="card p-5">
                        <p class="text-sm text-slate-500 dark:text-slate-400">Graded children</p>
                ...
                <section id="gradesTable" class="card mt-8 hidden overflow-hidden">
                    <div class="flex flex-col gap-2 border-b border-slate-200 p-5 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800">
                        ...
                        <button type="button" id="exportVisible"
                            class="inline-flex items-center gap-2 rounded border border-slate-200 px-3.5 py-2 text-sm font-semibold hover:border-slate-300 dark:border-slate-700">
    ...
    <dialog id="gradesModal"
        ...
        <div class="flex flex-col gap-4 border-b border-slate-200 p-6 sm:flex-row sm:items-center sm:justify-between dark:border-slate-800">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-xs font-semibold uppercase tracking-[0.16em] text-purple-600 dark:text-purple-400">Semestral grade details</p>
        ...
        <div class="p-6">
            <div class="mb-4 flex flex-wrap items-center gap-3 text-sm">
                <select id="modalSemester" aria-label="Semester" class="input w-40 rounded border px-3 py-2 text-sm font-semibold">
                    <option value="1st Semester">1st Semester</option>
                    <option value="2nd Semester">2nd Semester</option>
                </select>
                <select id="modalYear" aria-label="School year" class="input w-40 rounded border px-3 py-2 text-sm font-semibold"></select>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="bg-slate-50 text-xs uppercase text-slate-500 dark:bg-slate-800 dark:text-slate-400">
            ...
            <div class="mt-6 flex justify-end">
                <button type="button" data-close-grades class="rounded bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white hover:bg-slate-700 dark:bg-slate-100 dark:text-slate-900">Close</button>
            </div>
        </div>
    </dialog>
    ...
    <template id="gradesRowTemplate">
        <tr class="border-t border-slate-100 dark:border-slate-800">
            ...
            <td data-grade-student-id class="p-4 font-mono text-xs text-slate-500 dark:text-slate-400"></td>
            <td data-grade-average class="p-4 font-bold text-purple-700 dark:text-purple-300"></td>
            <td class="p-4 text-right">
                <button type="button" data-view-grade class="inline-flex items-center gap-1.5 rounded bg-slate-900 px-3 py-2 text-xs font-semibold text-white hover:bg-purple-600 dark:bg-slate-100 dark:text-slate-900">
