...
<head>
    @include('partials.meta', ['pageTitle' => 'Change Password | Digitech College'])
        ...
        <div class="w-full max-w-md">
            <div class="card p-7 sm:p-9 shadow-xl">
                <div class="flex items-center gap-3">
                    <img src="{{ asset('images/16432.png') }}" class="w-12 h-12 rounded" alt="Digitech College logo">
                    <div>
                        <b>DIGITECH</b>
                        <small class="block text-[10px] tracking-widest text-slate-400">COLLEGE PORTAL</small>
                    </div>
                </div>
                <p class="mt-6 text-sm font-semibold text-green-600 dark:text-green-400">Security notice</p>
                ...
                <form method="POST" action="{{ route('auth.password.update') }}" class="space-y-4 mt-7">
                    ...
                    <label class="block text-sm font-medium">
                        ...
                        <input name="current_password" type="password" required autocomplete="current-password"
                            class="input mt-1 w-full rounded border px-3 py-3" placeholder="Enter current password">
                    </label>

                    <label class="block text-sm font-medium">
                        New password
                        <input name="password" type="password" required autocomplete="new-password" minlength="12"
                            class="input mt-1 w-full rounded border px-3 py-3" placeholder="12+ characters">
                    </label>
                    ...
                    <label class="block text-sm font-medium">
                        ...
                        <input name="password_confirmation" type="password" required autocomplete="new-password"
                            minlength="12"
                            class="input mt-1 w-full rounded border px-3 py-3" placeholder="Repeat new password">
                    </label>
                    ...
                    <button class="w-full bg-green-600 hover:bg-green-700 text-white rounded py-3.5 font-semibold">
                        Update password
                    </button>
                </form>
            </div>
