<aside id="side" class="sidebar fixed inset-y-0 left-0 z-40 w-64 -translate-x-full lg:translate-x-0 bg-white dark:bg-slate-900 border-r dark:border-slate-800">
    <div class="h-full flex flex-col">
        ...
        <nav class="p-3 space-y-1 flex-1">
            ...
            <a href="{{ route('teacher.students') }}" class="flex items-center gap-3 rounded px-3 py-2.5 text-sm font-medium 
            ...
            <a href="{{ route('teacher.profile') }}" class="flex items-center gap-3 rounded px-3 py-2.5 text-sm font-medium
