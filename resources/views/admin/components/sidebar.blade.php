<aside id="side"
    ...
    <div class="flex h-full flex-col">
        <div class="flex h-20 items-center gap-3 border-b border-slate-200 px-5 dark:border-slate-800">
            <img src="{{ asset('images/16432.png') }}" class="h-10 w-10 rounded object-cover" alt="Digitech College logo">
            <div>
        ...
        <nav class="flex-1 space-y-1 overflow-y-auto p-3">
            ...
            @endphp
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 rounded px-3 py-2.5 text-sm font-medium
            ...
            <a href="{{ route('admin.users') }}" class="flex items-center gap-3 rounded px-3 py-2.5 text-sm font-medium
            ...
            <details {{ $inRequests ? 'open' : '' }} class="group">
                ...
                <div class="ml-4 mt-1 space-y-1 border-l border-slate-200 pl-3 dark:border-slate-800">
                    ...
                    <a href="{{ route('admin.parent-links') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
                    ...
                    <a href="{{ route('admin.requirements') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
            ...
            <details {{ $inAcademics ? 'open' : '' }} class="group">
                ...
                <div class="ml-4 mt-1 space-y-1 border-l border-slate-200 pl-3 dark:border-slate-800">
                    <a href="{{ route('admin.attendance') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
                    ...
                    <a href="{{ route('admin.enrollment') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
                        {{ request()->routeIs('admin.enrollment')
                        ? 'nav-active' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800' }}">
                        <i data-lucide="clipboard-list" class="w-4"></i>
                        Enrollment
                    </a>
                    <a href="{{ route('admin.grades') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
                        {{ request()->routeIs('admin.grades')
                        ? 'nav-active' : 'text-slate-600 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-slate-800' }}">
                        <i data-lucide="chart-no-axes-combined" class="w-4"></i>
                        Grades
                    </a>
                    <a href="{{ route('admin.programs') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
            ...
            <details {{ $inEngagement ? 'open' : '' }} class="group">
                ...
                <div class="ml-4 mt-1 space-y-1 border-l border-slate-200 pl-3 dark:border-slate-800">
                    <a href="{{ route('admin.announcements') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
            ...
            <details {{ $inSystem ? 'open' : '' }} class="group">
                ...
                <div class="ml-4 mt-1 space-y-1 border-l border-slate-200 pl-3 dark:border-slate-800">
                    <a href="{{ route('admin.profile') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
                        {{ request()->routeIs('admin.profile')
                        ? 'nav-active' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-800' }}">
                        <i data-lucide="user-round" class="w-4"></i>
                        Profile
                    </a>
                    <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 rounded px-3 py-2 text-sm font-medium
        ...
        <button
            type="button"
            data-logout
            class="m-3 flex items-center gap-3 rounded px-3 py-2.5 text-sm font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 dark:text-red-400">
