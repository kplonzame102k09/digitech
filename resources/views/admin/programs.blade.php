...
<head>
    @include('partials.meta', ['pageTitle' => 'Programs & TVET | Digitech College'])
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            <div class="mx-auto max-w-7xl">
                <section class="mb-7 p-6 sm:p-8">
                    <p class="text-sm font-semibold text-purple-600 dark:text-purple-400">Admissions catalogue</p>
                ...
                <div class="mb-6 flex flex-wrap gap-2 rounded-2xl border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900">
                    <button type="button" data-tab="programs"
                        class="programs-tab rounded px-4 py-2.5 text-sm font-semibold">Strand / Track</button>
                    <button type="button" data-tab="tvet"
                        class="programs-tab rounded px-4 py-2.5 text-sm font-semibold">TVET</button>
                </div>
                <section data-pane="programs" class="space-y-6">
                    <div class="card p-6">
                        <div class="flex items-start gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded bg-purple-50 text-purple-700 dark:text-purple-300 dark:bg-purple-950/40">
                        ...
                        <div class="mt-5 grid gap-3 sm:grid-cols-2">
                            <div class="rounded bg-slate-50 p-4 dark:bg-slate-800">
                                <p class="text-xs text-slate-500 dark:text-slate-400">Entries</p>
                                <b id="programCount" class="mt-1 block text-2xl">0</b>
                            </div>
                            <div class="rounded bg-slate-50 p-4 dark:bg-slate-800">
                                <p class="text-xs text-slate-500 dark:text-slate-400">Fallback to built-in defaults</p>
                        ...
                        <div class="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,150px)_auto]">
                            ...
                            <div class="flex items-end">
                                <button type="button" data-save-catalogue
                                    class="inline-flex w-full items-center justify-center gap-2 rounded bg-green-600 px-5 py-2.5 font-semibold text-white hover:bg-green-700">
                                    <i data-lucide="check" class="h-4 w-4"></i>
                                    Save
                                </button>
                            </div>
                        </div>
                        <p id="programFeedback" class="mt-3 text-xs text-slate-500 dark:text-slate-400"></p>
                        <div class="mt-6 overflow-x-auto rounded border border-slate-200 dark:border-slate-700">
                        ...
                        <p id="programHint" class="mt-3 text-xs text-slate-500 dark:text-slate-400"></p>
                    </div>
                </section>
                <section data-pane="tvet" class="hidden space-y-6">
                    <div class="card p-6">
                        <div class="flex items-start gap-3">
                            <span class="flex h-10 w-10 items-center justify-center rounded bg-amber-50 text-amber-700 dark:text-amber-300 dark:bg-amber-950/40">
                        ...
                        <p id="tvetFeedback" class="mt-3 text-xs text-slate-500 dark:text-slate-400"></p>
                        <div class="mt-6 overflow-x-auto rounded border border-slate-200 dark:border-slate-700">
                            <table class="w-full text-left text-sm">
                                <thead class="bg-slate-50 dark:bg-slate-800">
                                    <tr>
                        ...
                        <p id="qualificationHint" class="mt-3 text-xs text-slate-500 dark:text-slate-400"></p>
                    </div>
                </section>
            </div>
        </main>
