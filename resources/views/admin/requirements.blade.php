...
<head>
    @include('partials.meta', ['pageTitle' => 'Requirements management | Digitech College'])
...
<body data-role="admin" data-feature="requirements" class="min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
   @include('admin.components.sidebar')
    <div class="lg:pl-64">
        @include('admin.components.header', ['title' => 'Requirements', 'subtitle' => 'Student Services'])
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <section class="card overflow-hidden">
                    <div class="border-b border-slate-200 px-5 py-4 dark:border-slate-800">
                        <h3 class="font-extrabold">Review queue</h3>
                        <p class="text-xs text-slate-400">Approve or reject submitted requirements.</p>
                    </div>
