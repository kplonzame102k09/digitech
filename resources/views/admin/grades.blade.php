...
<body class="min-h-screen bg-slate-50 text-slate-800 dark:bg-slate-950 dark:text-slate-100">
    ...
    <div class="lg:pl-64">
        @include('admin.components.header', ['title' => 'Grades', 'subtitle' => 'Academics'])
            ...
            <div class="mx-auto max-w-7xl">
                ...
                <div class="mb-6 flex flex-wrap items-center gap-2 rounded-2xl border border-slate-200 bg-white p-3 dark:border-slate-700 dark:bg-slate-900">
                    ...
                    <button type="button" data-export-grades
                        class="inline-flex items-center justify-center gap-2 rounded border border-slate-200 px-4 py-3 text-sm font-semibold dark:border-slate-700">
                ...
                <div class="grid gap-4 sm:grid-cols-4">
                    <div class="card p-5">
                        <p class="text-xs text-slate-500 dark:text-slate-400">Students with grades</p>
                        <b id="studentCount" class="mt-2 block text-2xl"></b>
                    </div>
                    <div class="card p-5">
                        <p class="text-xs text-green-600 dark:text-green-400">General average</p>
                        <b id="generalAverage" class="mt-2 block text-2xl"></b>
                    </div>
                    <div class="card p-5">
                        <p class="text-xs text-blue-600 dark:text-blue-400">GWA (CHED)</p>
                        <b id="gwaCount" class="mt-2 block text-2xl"></b>
                    </div>
                    <div class="card p-5">
                        <p class="text-xs text-amber-600 dark:text-amber-400">Published subjects</p>
                ...
                <section class="card mt-5 overflow-hidden">
                    ...
                    <div id="emptyState" class="hidden p-10 text-center">
                        ...
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">Grades for the selected semester appear here.</p>
                    </div>
                </section>
            </div>
        </main>
        ...
        <tr class="border-t border-slate-100 dark:border-slate-800">
            ...
            <td class="p-4 text-right">
                <button type="button" data-action="view"
                    class="inline-flex items-center gap-1.5 rounded bg-slate-900 px-3 py-2 text-xs font-semibold text-white hover:bg-green-600 dark:bg-slate-100 dark:text-slate-900">
        ...
        <tr class="border-t border-slate-100 dark:border-slate-800">
            ...
            <td class="p-2 text-right">
                <div class="flex items-center justify-end gap-2">
                    <select data-row-published class="input w-28 rounded border px-2 py-1.5 text-xs"
